    ...
    <main className="shell">
      <nav className="nav">
        ...
        <div className="nav-links">
          <Link className="pill" href="/upload">Spectrogram lab</Link>
      ...
      <section className="hero">
        <div className="panel copy">
          ...
          <p>
            This prototype validates the upgraded stack with two focused experiences: source-specific spectrograms with sweep, upload, and microphone modes, and a gallery where generated sound and
            visual motion share the same playback clock.
          </p>
          <div className="actions">
            <Link className="button" href="/upload">Try spectrogram lab</Link>
